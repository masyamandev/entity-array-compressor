...
public class DoulbeFixedLongDiffSerializationFactoryTest {

    public static final SerializationFactory FACTORY = DoubleFixedDiffSerializationFactory.INSTANCE;
    ...
    public void testLongInfinity() throws Exception {
        ...
        byte[] bytes = os.toByteArray();
        assertThat(bytes.length).isLessThan(serializerBytes.length + 2 * 9);
