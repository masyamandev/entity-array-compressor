...
public class SignedLongDiffSerializationFactory extends SerializationFactory<Number> {

    public static final SignedLongDiffSerializationFactory INSTANCE = new SignedLongDiffSerializationFactory();

    private SignedLongDiffSerializationFactory() {
        super("_SLD");
    }
    ...
    public <E extends Number> Serializer<E> createSerializer(DataWriter os, TypeDescriptor<E> type) throws IOException {
        ...
        return convertFrom(diffSerializer(new LongSerializer(os)), type);
    }
    ...
    public <E extends Number> Deserializer<E> createDeserializer(DataReader is, TypeDescriptor<E> type) throws IOException {
        ...
        return convertTo(diffDeserializer(new LongDeserializer(is)), type);
    }
